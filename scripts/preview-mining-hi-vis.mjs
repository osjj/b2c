...
const slug = 'mining-high-visibility-workwear-guide'
const dir = path.join(root, 'output', 'mining-hi-vis-review')
...
</style></head><body><header><div class="eyebrow">LAIFAPPE / Mining &amp; Quarrying / Buyer guide</div><h1>${esc(config.title)}</h1><p>${esc(config.excerpt)}</p><div class="review">Local review · September 16, 2026 · Not published</div></header><main><figure class="hero"><img src="images/hero.webp" alt="High-visibility workwear samples in a sheltered quarry issue bay"><figcaption>Illustrative workwear samples; no performance class is claimed. Select the actual model from documented task requirements and supplier evidence.</figcaption></figure><nav aria-label="Article contents"><details><summary>In this guide</summary><ul>${toc}</ul></details></nav>${htmlBlocks}<footer>Local article review. Images illustrate selection and compatibility decisions; they are not product performance evidence.</footer></main></body></html>`
...
let illustrated = markdown.replace('\n---\n', '\n---\n\n![Mining high-visibility workwear samples](images/hero.webp)\n')
