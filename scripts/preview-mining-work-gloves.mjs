...
const slug = 'mining-work-gloves-maintenance-material-handling'
const dir = path.join(root, 'output', 'mining-gloves-review')
...
</style></head><body><header><div class="eyebrow">LAIFAPPE / Mining &amp; Quarrying / Buyer guide</div><h1>${esc(config.title)}</h1><p>${esc(config.excerpt)}</p><div class="review">Local review · September 13, 2026 · Not published</div></header><main><figure class="hero"><img src="images/hero.webp" alt="Mechanical work glove samples on a quarry maintenance inspection table"><figcaption>Illustrative glove samples. Select the actual model from documented task requirements and supplier evidence.</figcaption></figure><nav aria-label="Article contents"><details><summary>In this guide</summary><ul>${toc}</ul></details></nav>${htmlBlocks}<footer>Local article review. Images illustrate purchasing and handling decisions; they are not product performance evidence.</footer></main></body></html>`
...
let illustrated = markdown.replace('\n---\n', '\n---\n\n![Mining work glove samples](images/hero.webp)\n')
