...
OSHA's construction rule is direct on this topic. Under [29 CFR 1926.102](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102), the employer must ensure that each affected employee uses appropriate eye or face protection when exposed to hazards from flying particles, molten metal, liquid chemicals, acids or caustic liquids, chemical gases or vapors, or potentially injurious light radiation.

The most important construction points are:

- [29 CFR 1926.102(a)(1)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) requires appropriate eye or face protection when the hazard exists.
- [29 CFR 1926.102(a)(2)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) requires eye protection with side protection where there is a hazard from flying objects.
- [29 CFR 1926.102(a)(3)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) requires a worker who wears prescription lenses to use protection that incorporates the prescription or can be worn over it without disturbing lens position.
- [29 CFR 1926.102(a)(5)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) says protectors must be adequate for the hazard, reasonably comfortable, fit snugly, be durable, and be cleanable.
- [29 CFR 1926.102(b)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) ties construction eye and face PPE to ANSI consensus standards, including ANSI/ISEA Z87.1-2010, ANSI Z87.1-2003, and ANSI Z87.1-1989 (R-1998), or devices shown to be at least as effective.

This sits inside the wider PPE rules in [29 CFR 1926.95](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.95), including the explicit fit requirement that took effect on **January 13, 2025**. For eyewear, fit problems are not theoretical:
...
For welding and cutting, [29 CFR 1926.102(c)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102) points employers to OSHA's filter-lens shade table. For laser use in construction, [29 CFR 1926.54](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.54) adds separate rules, including ant-laser eye protection where workers can be exposed above the threshold in the standard.
...
In practice, buyers usually need to separate two common goggle problems:

- **dust-entry control**: the job is dry, dirty, and particle-heavy, so the main question is whether dust is still getting around ordinary glasses
- **splash control**: the job involves liquids, chemicals, wet cutting, or spray, so the main question is whether the protector can keep liquid out of the eye area

That distinction matters because the site may not need the exact same goggle setup for both conditions. A worker mixing or applying chemicals is not solving the same problem as a worker doing dusty demolition, even if both end up in goggles.
...
| Construction task | Main eye or face hazard | PPE direction to start with | What to check before buying | Common selection mistake |
|---|---|---|---|---|
| General site movement and light task support | incidental flying particles | safety glasses with side protection | comfort, anti-slip fit, clear visibility, hard-hat compatibility | issuing ordinary eyewear or glasses without side protection |
| Grinding, chipping, and abrasive cutting | high-speed particles, sparks, face-level debris | safety glasses plus face shield for heavier debris tasks | side protection, lens clarity, face coverage, stability during movement | wearing a face shield alone |
| Concrete cutting, masonry, drywall, and dusty demolition | dust, chips, fine particles | glasses for lighter exposure, goggles when dust entry becomes the issue | dust entry around cheeks and brow, fogging, respirator compatibility | assuming ordinary glasses are enough for heavy dust |
| Sealants, cleaners, fuels, adhesives, and liquid chemicals | splash, irritation, contamination | splash-capable goggles, sometimes with face shield for broader splash risk | seal, liquid control, compatibility with respirator or hard hat | using open glasses where splash can enter from the side or below |
| Welding, cutting, and brazing | radiant energy, sparks, hot particles | welding helmet or goggles with proper filter shade, plus primary eye protection where debris remains | minimum shade, task-specific hood selection, side protection under the hood when needed | using the wrong shade or lifting the hood without primary eye protection |
| Demolition and high-debris removal | mixed chips, face strike, dust | primary eye protection plus face shield when face exposure is high | impact control, shield coverage, replacement frequency, dust control | relying on one light pair of glasses for all demolition work |
| Nail gun and fastening work | ricochet, flying fasteners, chips | safety glasses with side protection | stable fit, lens clarity, worker compliance | treating fastening work as too routine to require eyewear |
| Laser layout or specialty laser tasks | direct or reflected laser exposure | laser-specific eye protection where required under the laser rule | actual laser hazard, wavelength-specific protection, trained operators | using ordinary tinted eyewear as if it were laser protection |
...
Examples from [29 CFR 1926.102(c)](https://www.osha.gov/laws-regs/regulations/standardnumber/1926/1926.102):
...
### Start with obvious product-level signals

Before getting lost in catalog language, check the simple things first:

- does the protector meet the construction eye standard path under OSHA and ANSI Z87
- does it include side protection where flying-object hazard exists
- can it work over prescription lenses if the worker needs that
- does the frame or goggle actually stay stable during the task

On real jobsite purchases, that often matters more than a long marketing description.
...
### Read the marking and setup like a buyer, not like a catalog editor

For most construction teams, the practical product-reading questions are:

- is this just basic safety eyewear, or is it marked for higher-impact use
- are side shields built in, detachable, or missing
- is it a normal spectacle frame, an over-the-glasses setup, or a goggle
- is the product being sold as if it solves splash, dust, impact, and hot work all at once without showing how

That is where the ANSI Z87 marking still helps. It tells the buyer the device is in the occupational eye-protection standard family. From there, the buyer still has to confirm the configuration matches the task:

- side protection for flying objects
- goggle-style control where dust or splash entry is the real problem
- correct welding filter selection where radiant energy is the issue
- over-the-glasses or prescription-compatible fit where normal frames are not enough

The point is not to memorize every marking variant. The point is to stop treating any product with "safety" in the title as if it solves every construction eye hazard.
